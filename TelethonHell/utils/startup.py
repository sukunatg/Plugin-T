...
async def logger_id(client):
    desc = "A Bot Logger Group For FragBot. DO NOT LEAVE THIS GROUP!!"
    try:
        grp = await client(
            functions.channels.CreateChannelRequest(
                title="Fragbot Logger", about=desc, megagroup=True
            )
        )
...
<b><i>»» <u><a href='https://t.me/FRAG_GOD_HACKER'>†hê ʄʀǟɢɮօȶ</a></u> ««</i></b>
"""
    await client.send_file(
        ...
        caption=text,
        parse_mode="HTML",
        buttons=[[Button.url("OWNER", "https://t.me/FRAG_GOD_HACKER")]],
    )
