...
ALIVE_TEMP = """
<b><i>🔥🔥ʄʀǟɢɮօȶ ɨֆ օռʟɨռɛ🔥🔥</i></b>
<b><i>↼ Øwñêr ⇀</i></b> : 『 {hell_mention} 』
╭──────────────
┣─ <b>» Telethon:</b> <i>{telethon_version}</i>
┣─ <b>» ʄʀǟɢɮօȶ:</b> <i>{hellbot_version}</i>
┣─ <b>» Sudo:</b> <i>{is_sudo}</i>
┣─ <b>» Uptime:</b> <i>{uptime}</i>
┣─ <b>» Ping:</b> <i>{ping}</i>
╰──────────────
<b><i>»»» <a href='https://t.me/FRAG_GOD_HACKER'>[†hê ʄʀǟɢɮօȶ]</a> «««</i></b>
"""
...
async def hell_a(event):
    ...
    uptime = await get_time((time.time() - StartTime))
    am = gvarstat("ALIVE_MSG") or "<b>»» 𝓯𝓻𝓪𝓰𝓫𝓸𝓽 𝓲𝓼 𝓸𝓷𝓵𝓲𝓷𝓮 ««</b>"
    try:
