...
if Config.BOT_USERNAME and tbot:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "hellbot_help":
            ...
            if a:
                ...
                help_pic = "https://graph.org/file/cb81de4464c314df92634.jpg"
            ...
            alive_msg = gvarstat("ALIVE_MSG") or "»»» <b>ʄʀǟɢɮօȶ ιѕ σиℓιиє</b> «««"
            ...
            if a:
                ...
                PIC = "https://graph.org/file/0a4a969abb3c51ca5987b.mp4"
            ...
            if a and a == "DISABLE":
                ...
                PIC = "https://graph.org/file/83288d14c8bc7723f8497.jpg"
            if PIC and PIC.endswith((".jpg", ".png")):
                result = builder.photo(
                    file=PIC,
                    text=HELL_FIRST,
            ...
            result = builder.article(
                title="Repository",
                text=f"**⚡ ʟɛɢɛռɖaʀʏ ᴀғ ʄʀǟɢɮօȶ ⚡**",
                buttons=[
                    [Button.url("📑 Repo 📑", "https://graph.org/for-telegram-offecials-04-29")],
                    [Button.url("◤✧ 𝖋𝖗𝖆𝖌𝖚𝖇 ✧◥", "https://t.me/FRAG_GOD_HACKER")],
                ],
            )
            ...
            result = builder.article(
                "FragBot",
                text="""**Hey! This is [ʄʀǟɢɮօȶ](https://t.me/FRAG_GOD_HACKER) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        Button.url("• Creator •", "https://t.me/FRAG_GOD_HACKER"),
                        Button.url("• Help •", "https://t.me/FRAG_GOD_HACKER"),
                    ],
                    [
                        Button.url("• Repo •", "https://graph.org/for-telegram-offecials-04-29"),
                        Button.url("• Help •", "https://FRAG_GOD_JACKER"),
                    ],
                    [
                        Button.url("◈ ◤✧ 𝖋𝖗𝖆𝖌𝖚𝖇 ✧◥ ◈", "https://t.me/FRAG_GOD_HACKER"),
                    ],
    ...
    async def on_pm_click(event):
        ...
        if event.query.user_id in auth:
            ...
            reply_popup = "🔰 This is ʄʀǟɢɮօȶ PM Security to keep away unwanted retards from spamming PM !!"
    ...
    async def reopn(event):
        ...
        if event.query.user_id in auth:
            ...
            await event.answer("Hello! This help menu is not for you, This is only for my master", cache_time=0, alert=True)
    ...
    async def page(event):
        ...
        if event.query.user_id in auth:
            ...
            return await event.answer(
                "Hello! This help menu is not for you, This is only for my master",
                cache_time=0,
                alert=True,
            )
