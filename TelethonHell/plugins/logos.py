...
CmdHelp("logos").add_command(
    "logo", "-{type} {logo text}", "Makes a logo with the given text. If replied to a picture makes logo on that else gets random BG.", f"logo FragBot \n{hl}logo-car FragBot \n{hl}logo-anime FragBot \netc..."
).add_info(
    "Logo Maker."
).add_warning(
    "✅ Harmless Module."
